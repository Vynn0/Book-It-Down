...
import AcUnitIcon from '@mui/icons-material/AcUnit';
import ElectricalServicesIcon from '@mui/icons-material/ElectricalServices';
// Pastikan path untuk icon-icon lainnya sudah benar
  ...
  return (
    ...
    >
      ...
      <CardContent sx={{ p: 2 }}>
        ...
        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mb: 2 }}>
          {features.includes('AC') && (
            <Box sx={{ display: 'flex', alignItems: 'center', border: '1px solid #FF9B0F', borderRadius: '20px', px: 1.5, py: 0.5 }}>
              <AcUnitIcon sx={{ fontSize: '1rem', color: '#FF9B0F', mr: 0.5 }} />
              <Typography variant="caption" sx={{ color: '#FF9B0F', fontWeight: 'bold' }}>AC</Typography>
            </Box>
          )}
          {features.includes('Wall Socket') && (
            <Box sx={{ display: 'flex', alignItems: 'center', border: '1px solid #3C355F', borderRadius: '20px', px: 1.5, py: 0.5 }}>
              <ElectricalServicesIcon sx={{ fontSize: '1rem', color: '#3C355F', mr: 0.5 }} />
              <Typography variant="caption" sx={{ color: '#3C355F', fontWeight: 'bold' }}>Wall Socket</Typography>
            </Box>
          )}
        ...
        <Button 
          ...
          onClick={(e) => {
            e.stopPropagation(); // Mencegah event card click
            onBookClick();
          }}
        >
          Button
